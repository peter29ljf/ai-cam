...
## 版本记录
- v1.1 基本能用，目前只能采用智普ai api，加上本地lm studio的 gemma-3-12b-it 多模态模型进行图片读取。默认的地址http://192.168.1.217:1234，有需要修改的修改/ai-cam/server/process_images.py
- v1.0.8 增加一件图片转md功能
...
3. **停止服务**
   ...
   ```bash
   ./stop_all_servers.sh
4. 在ui设置中配置好智普的api 信息，然后必须重启服务器！！！才能生效
   ```
